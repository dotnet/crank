...
//         public void Resolve_WhenCalledWithDecimalValue_ReturnsTrueAndSetsCurrentTypeToDecimal()
//         {
//             // Arrange
...
//         }
        ...
        /// </summary>
        [TestMethod]
        public void Resolve_WhenCalledWithBooleanValue_ReturnsTrueAndSetsCurrentTypeToBoolean()
        {
            // Arrange
        ...
        /// </summary>
        [TestMethod]
        public void Resolve_WhenCalledWithNonDecimalAndNonBooleanValue_ReturnsFalse()
        {
            // Arrange
            var scalar = new Scalar(null, null, "someString", ScalarStyle.Any, true, false);
            var nodeEvent = (NodeEvent)scalar;
            Type currentType = null;
        ...
        /// <summary>
        /// Tests the <see cref="JsonTypeResolver.Resolve(NodeEvent, ref Type)"/> method to ensure it returns false for non-plain implicit scalar values.
        /// </summary>
        [TestMethod]
        public void Resolve_WhenCalledWithNonPlainImplicitScalarValue_ReturnsFalse()
        {
            // Arrange
