...
Options:
  ...
  --[JOB].collectArguments <arguments>                                     Native traces arguments, e.g., "BufferSizeMB=1024;CircularMB=4096;clrEvents=JITSymbols;kernelEvents=process+thread+ImageLoad+Profile"
